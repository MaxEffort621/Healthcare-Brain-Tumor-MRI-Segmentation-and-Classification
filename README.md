...
```bash
git clone https://github.com/MaxEffort621/Brain-Tumor-MRI-Segmentation-and-Classification.git
cd Brain-Tumor-MRI-Segmentation-and-Classification
```
